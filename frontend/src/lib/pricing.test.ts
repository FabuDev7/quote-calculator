...
describe('pricing engine', () => {
    it('calcola Base vs Standard con cap 1.5', () => {
        const out = computeTotals({
            model: 'HOURLY', profession: 'developer', rateHourly: 60, hours: 10, bufferPct: 0.1,
    ...
    it('applica buffer dopo i moltiplicatori', () => {
        const a = computeTotals({ model: 'HOURLY', profession: 'developer', rateHourly: 100, hours: 1, bufferPct: 0.1, extraHours: { sopralluogo:0,call:0,setup:0,custom:0 }, fees: { trasferte:0,licenze:0,consumabili:0,noleggi:0,altro:0 }, multipliers: { urg:1, cplx:1, risk:1 } })
